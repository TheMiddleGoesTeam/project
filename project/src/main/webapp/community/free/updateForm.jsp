...
<body>
    ...
    <%
     int boardNum= Integer.parseInt(request.getParameter("num"));
		...
		Board_FreeVO vo = dbPro.updateGetArticle(boardNum);
	%>
        ...
        <div class="container">
	        <div class="container-740">
	            ...
	            <form action="updateProc.jsp" method="post" name="updateForm" onsubmit="return writeSave();">
					...
					<input type ="hidden" name="fepth"	 value="<%=depth %>"	>
					
					
					<table class="table is-fullwidth">
						<tr>
							<th>이름</th>
							<td><input type="text" size="12" maxlength="12" name="fWriter" class="input"  value="<%=vo.getfWriter()%>"></td>
						</tr>
						<tr>
							<th>제목</th>
							<td>
								<input type="text" size="50" maxlength="50" name="fTitle" class="input" value="<%= vo.getfTitle() %>">
								
							</td>
						</tr>
						<tr>
							<th>내용</th>
							<td><textarea rows="13" cols="50" name="fContents" class="textarea" ><%= vo.getfContents() %></textarea></td>
						</tr>
						<tr>
							<th>비밀번호</th>
							<td><input type="password" size="10" maxlength="10" name="fPass" class="input" value="<%= vo.getfPass() %>"></td>
						</tr>
					</table>
