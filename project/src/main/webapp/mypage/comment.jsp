	...
	<section id="mypage" class="section write">
		<div class="menu">
			<ul>
				...
				<li><a href="<%=request.getContextPath()%>/mypage/comment.jsp" class="button is-medium is-rounded is-success">내 댓글 목록</a></li>
		...
		<div class="container">
			<div class="inner">
				<form action="infoProc.jsp" method="post" name="myInfo">
					<h4 class="title is-4">내 댓글 목록</h4>
