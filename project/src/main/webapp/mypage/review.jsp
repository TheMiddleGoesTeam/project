	...
	<section id="mypage" class="section write">
		<div class="menu">
			<ul>
				...
				<li><a href="<%=request.getContextPath()%>/mypage/review.jsp" class="button is-medium is-rounded is-success">리뷰한 상품</a></li>
		...
		<div class="container">
			<div class="inner">
				<form action="infoProc.jsp" method="post" name="myInfo">
					<h4 class="title is-4">리뷰한 상품 목록</h4>
